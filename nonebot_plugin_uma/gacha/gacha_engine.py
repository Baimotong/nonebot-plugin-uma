...
class Gacha:
    def __init__(self, pool_id: str, gacha_type: str, server: str = "jp", gacha_dir: Path = None):
        self.server = server
    ...
    @staticmethod
    def get_pool(pool_id: str, server: str, gacha_dir: Path = None) -> dict:
    ...
    def gacha_one(self, up_prob: int, s3_prob: int, s2_prob: int, s1_prob: int = 0):
    ...
    def gacha_full_singer(self, result: dict, first_up: int, chart_name_list: list[str]):
